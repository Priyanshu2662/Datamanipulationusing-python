...
def Main_menu():
    ...
    print("2. Data visualization method")
...
def data_manipulation():
    ...
    print("3.Average of the data")
    print("4.sum of the data")
    print("5.median of the data")
    print("6.delete the 14th row")
    print("7.Add the new row")
    print("8.Delete the 4th and 18th row")
    print("9.delete the writing score")
